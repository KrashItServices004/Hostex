        ...
        <div className='col-sm-12  mx-auto'>
            ...
            <div className='row mx-auto'>
                <div className='col-sm-6'>
                    ...
                    <div className="mb-3">
                        <label for="exampleFormControlTextarea1" className="form-label"> Evidence or logs of the activity showing source IP.</label>
                        <textarea className="form-control" id="exampleFormControlTextarea1" rows="4"></textarea>
                    </div>
                </div>
                <div className='col-sm-6'>
                    <div className="mb-3">
                        <label for="exampleFormControlTextarea1" className="form-label">Your servers time zone</label>
                        <textarea className="form-control" id="exampleFormControlTextarea1" rows="4"></textarea>
                    </div>
                </div>
            </div>
