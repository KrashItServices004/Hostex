                ...
                <div className='col-sm-12  mx-auto'>
                    ...
                    <div className='row mx-auto'>
                        <div className='col-sm-6'>
                            ...
                            <div className="mb-3">
                                <label for="exampleFormControlTextarea1" className="form-label">Headers from email received</label>
                                <textarea className="form-control" id="exampleFormControlTextarea1" rows="4"></textarea>
                            </div>
                        </div>
                        <div className='col-sm-6'>
                            <div className="mb-3">
                                <label for="exampleFormControlTextarea1" className="form-label">Message Body</label>
                                <textarea className="form-control" id="exampleFormControlTextarea1" rows="4"></textarea>
                            </div>
                        </div>
                    </div>
                    <div className='row mx-auto'>
                        <div className='col-sm-12 '>
                            <div className='mb-3'>
                                <label for="exampleFormControlTextarea1" className="form-label">Spamvertisement URLs</label>
                                <textarea className="form-control" id="exampleFormControlTextarea1" rows="4"></textarea>
                            </div>
                        </div>
                    </div>
